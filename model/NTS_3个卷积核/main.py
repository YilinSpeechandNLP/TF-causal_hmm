...
def main():
    ...
    causal_hmm_model = Causal_HMM(args, z_size=args.z_size, v_size=args.v_size,s_size=args.s_size,
                      A_size=15, B_size=1, batch_size=args.batch_size, layer_count = args.cnn_layer, channels = 3)
    ...
    train_label_path = 'data/train_data.csv'
    val_label_path = 'data/val_data.csv'
    test_label_path = 'data/test_data.csv'
